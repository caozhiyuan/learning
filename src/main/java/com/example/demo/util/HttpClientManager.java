...
public class HttpClientManager {
    ...
    private class HttpAsyncClient {

        private int socketTimeout = 1000;// 设置等待数据超时时间5秒钟 根据业务调整

        private int connectTimeout = 2000;// 连接超时

        private int poolSize = 10240;// 连接池最大连接数

        private int maxPerRoute = 512;// 每个主机的并发最多只有1500
    ...
    public HttpClientManager() {
        closeableHttpAsyncClient = httpAsyncClient.getAsyncHttpClient();
